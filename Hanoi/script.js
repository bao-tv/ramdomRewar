...
async function setReward(selectedMenber) {
  ...
  <div class="name">${selectedMenber.name} - ${selectedMenber.id}</div>
  <div class="department"> ${selectedMenber.department}${selectedMenber.table ?`- Chức danh ${selectedMenber.table}` : ''}</div>
  `
